"""Typed Presence Presence schedule contracts."""
...
class PresenceScheduleUpdateRequest(BaseModel):
    ...
    def validate_contract(self):
        ...
        if self.status == "active" and self.destination_mode == "bound_conversation" and self.bound_conversation_id is None:
            raise ValueError("bound_conversation_id is required before enabling custom destination mode")
...
class PresenceTriggerRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")
